            ...
            <div className="min-h-screen flex items-center justify-center p-4">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-lg text-[#6EACDA]">Welcome back!</p>
                    </motion.div>
                    ...
                    >
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <h2 className="text-2xl font-semibold text-[#E2E2B6] text-center">Sign In</h2>
                            ...
                            <div className="text-center">
                                <Link to="/signup" className="text-[#6EACDA] hover:opacity-80 transition-opacity">
