                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {enrolledCourses.map((course, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-[#f8f8f8]/70 mb-4 line-clamp-2">{course.description}</p>
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-[#222052] border border-[#f8f8f8]/20 rounded-lg p-4 text-center">
                            <div className="text-2xl font-bold text-[#f8f8f8]">{filteredCourses.length}</div>
                            <div className="text-sm text-[#f8f8f8]/70">Available Courses</div>
                        </div>
                        <div className="bg-[#222052] border border-[#f8f8f8]/20 rounded-lg p-4 text-center">
                            <div className="text-2xl font-bold text-[#f8f8f8]">{enrolledCourses.length}</div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mb-4 text-sm">
                                        <span className="text-[#f8f8f8]/60">By: {course.teacher}</span>
                    ...
                    {filteredCourses.length === 0 && searchTerm && (
                        ...
                        >
                            <div className="text-6xl mb-4">🔍</div>
                            <h4 className="text-xl font-semibold text-[#f8f8f8] mb-2">No courses found</h4>
                            <p className="text-[#f8f8f8]/70">Try adjusting your search terms</p>
                        </motion.div>
                    )}
                </motion.section>
            </main>
